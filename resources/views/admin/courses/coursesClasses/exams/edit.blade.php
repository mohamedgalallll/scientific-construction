...
@section('content')
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            @include('admin.layout.panels.breadcrumb', ['pageName' => '' ,'items'=>[
     [
     'name'=>'الكورسات',
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                @include('admin.components.inputs.radio', [
                                                                            ...
                                                                            'class' => 'success',
                                                                            'label' => '',
                                                                            'checked' => $item->correct_answer === $item->answer_1 ? true : false,
                                                                            'disabled' => false,
                                                                            ])
                                                                @include('admin.components.inputs.text', [
                                                                  'name' => 'answer_1',
                                                            ...
                                                            <div class="col-md-6">
                                                                @include('admin.components.inputs.radio', [
                                                                            ...
                                                                            'value' => 'answer_2',
                                                                             'class' => 'success',
                                                                            'label' => '',
                                                                            'checked' => $item->correct_answer === $item->answer_2 ? true : false,
                                                                            'disabled' => false,
                                                                            ])
                                                                @include('admin.components.inputs.text', [
                                                                  'name' => 'answer_2',
                                                            ...
                                                            <div class="col-md-6">
                                                                @include('admin.components.inputs.radio', [
                                                                           ...
                                                                           'value' => 'answer_3',
                                                                            'class' => 'success',
                                                                           'label' => '',
                                                                           'checked' => $item->correct_answer === $item->answer_3 ? true : false,
                                                                           'disabled' => false,
                                                                           ])
                                                                @include('admin.components.inputs.text', [
                                                                  'name' => 'answer_3',
                                                            ...
                                                            <div class="col-md-6">
                                                                @include('admin.components.inputs.radio', [
                                                                         ...
                                                                         'class' => 'success',
                                                                         'label' => '',
                                                                         'checked' => $item->correct_answer === $item->answer_4 ? true : false,
                                                                         'disabled' => false,
                                                                         ])
                                                                @include('admin.components.inputs.text', [
                                                                  'name' => 'answer_4',
