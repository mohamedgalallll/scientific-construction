...
{{request()->cookie('navbar_type') == 'navbar-static' ? 'd-none' : ''}}
        ...
        <div class="content-wrapper">
            @include('admin.layout.panels.breadcrumb', ['pageName' => trans('web.fontAwesome'),'items'=>[
         [
         'name'=>'',
         'url'=>'',
         ]
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="feather-icons overflow-hidden row">
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-arrow-circle-o-down"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-exclamation-circle"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-exclamation-triangle"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-arrow-circle-right"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-google-plus-square"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-adminmap"></i></div>
                                                <label class="fonticon-classname">fa-adminmap</label>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-angle-double-right"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-chevron-circle-left"></i>
                                                </div>
                                                <label class="fonticon-classname">fa-chevron-circle-left</label>
                                                <label class="fonticon-unit">f137</label>
                                            </div>
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-chevron-circle-right"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-chevron-circle-down"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-external-link-square"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-caret-square-o-down"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-caret-square-o-right"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-stumbleupon-circle"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-battery-three-quarters"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-odnoklassniki-square"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-volume-control-phone"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i
                                                        class="fa fa-assistive-listening-systems"></i></div>
                                                <label class="fonticon-classname">fa-assistive-listening-systems</label>
                                                <label class="fonticon-unit">f2a2</label>
                                            </div>
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i
                                                        class="fa fa-american-sign-language-interpreting"></i></div>
                                                <label
                                                    class="fonticon-classname">fa-american-sign-language-interpreting</label>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-google-plus-official"></i>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i
                                                        class="fa fa-thermometer-three-quarters"></i></div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-12 fonticon-container">
                                                <div class="fonticon-wrap"><i class="fa fa-thermometer-quarter"></i>
                                                </div>
