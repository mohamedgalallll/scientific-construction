...
@section('pageName','كلمات ف حق الموقع ')
@section('thead')
    <tr>
        <th>صوره المحاضر </th>
        <th>اسم المحاضر </th>
        <th>كلمات ف حق الموقع</th>
...
@section('modal')
    @include('admin.about.instructorWords.create',['id'=>'createmodal','name'=>'انشاء كلمه ف حق الموقع ','action'=>url()->current()])
@stop
@endif
                ...
                "columns": [
                    {
                        "mRender": function (data, type, row) {
                            return  '<div class="avatar  avatar-xl"><img src="'+row.instructor_image+'" alt="Img placeholder"></div>';
