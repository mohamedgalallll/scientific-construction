<script>
    (function (window, document, $) {
        ...
        var selectedColor = '{{request()->cookie('theme_color')}}',
        ...
        if(body.data('menu')=="horizontal-menu"){
            ...
            $('.customizer .customizer-toggle').css(
                {
                    "background": changeColor,
                    "box-shadow": selectedShadow
                }
        ...
        if (body.hasClass("menu-collapsed")) {
            ...
            var sidebar_switch = 'menu-collapsed';
        } else {
            collapseSidebar.prop("checked", false);
            var sidebar_switch = 'menu-expanded';
        }

            $.ajax({
                url: "{{url('admin/theme_sidebar_switch')}}",
                type: "POST",
                async: true,
                dataType: 'json',
                data: {
        ...
        $("#customizer-navbar-colors .color-box").on("click", function () {
            ...
            $.ajax({
                url: "{{url('admin/theme_nav_bar_color')}}",
                type: "POST",
                async: true,
                dataType: 'json',
                data: {
        ...
        $("#navbar-hidden").on("click", function () {
            ...
            var nav_bar_type = 'navbar-hidden';
            $.ajax({
                url: "{{url('admin/theme_nav_bar_type')}}",
                type: "POST",
                async: true,
                dataType: 'json',
                data: {
                    _token:"{{csrf_token()}}",
                    nav_bar_type : nav_bar_type,
                }
            });
        });
        ...
        $("#navbar-static").on("click", function () {
            ...
            var nav_bar_type = 'navbar-static';
            $.ajax({
                url: "{{url('admin/theme_nav_bar_type')}}",
                type: "POST",
                async: true,
        ...
        $("#navbar-floating").on("click", function () {
            ...
            var nav_bar_type = 'navbar-floating';
            $.ajax({
                url: "{{url('admin/theme_nav_bar_type')}}",
                type: "POST",
                async: true,
        ...
        $("#navbar-sticky").on("click", function () {
            ...
            var nav_bar_type = 'navbar-sticky';
            $.ajax({
                url: "{{url('admin/theme_nav_bar_type')}}",
                type: "POST",
                async: true,
        ...
        $("#footer-hidden").on("click", function () {
            ...
            var footer_data = 'footer-hidden';
            $.ajax({
                url: "{{url('admin/theme_footer_type')}}",
                type: "POST",
                async: true,
                dataType: 'json',
                data: {
        ...
        $("#hide-scroll-top-switch").on("click", function () {
            ...
            if ($(this).prop("checked")) {
                ...
                var scroll_top = 'enabled' ;
            }
            else {
                scrollTopBtn.removeClass("d-none");
                var scroll_top = 'disabled';
            }
            $.ajax({
                url: "{{url('admin/theme_scroll_top')}}",
                type: "POST",
                async: true,
                dataType: 'json',
                data: {
