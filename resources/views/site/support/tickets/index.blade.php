...
@section('content')
                        ...
                        <div class="col-7 col-md-8 col-lg-9">
                            <div class="head-profile">
                                ...
                                <div class="inlineBlock">
                                    <p class="mb-2 h5 font-weight-bolder">  الدعم الفنى - <span class="font-14 text-muted">التذاكر الخاصه بى</span></p>
        ...
        @include('site.layout.scripts.support.support-6')
@stop
