                ...
                <div class="course-desc-page">
                    <div class="row">
                        <div class="col-6 col-lg-9">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-5">
                                    <p class="mb-2 h6 font-weight-bolder">فوائد الفصل الاول</p>
                                </div>
                                ...
                                <div class="col-12 col-lg-3 icon-ques-8 pt-1 ">
                                    <a href="">
                                        <span class="px-1"><i class="fas fa-file-word " style="font-size:20px"></i></span>
                                    </a>
                                    <a href="">
                                        <span class="px-1"><i class="fas fa-file-pdf" style="font-size:20px"></i></span>
                                    </a>
                                    <a href="">
                                        <span class=" text-success px-1"><i class="  fas fa-edit" style="font-size:20px"></i></span>
                                    </a>
                                    <a href="">
                                        <span class="text-dark px-1"><i class="fas fa-trash" style="font-size:20px"></i></span>
                                    </a>
                                </div>
                            </div>
                            <div>
