                        ...
                        <div class="col-6 col-lg-9">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-3 col-lg-6">
                                    <p class="mb-2 h6 font-weight-bolder">تلخيص</p>
                                </div>
                                <div class="col-md-4 col-lg-3 icon-ques">
                                    <div class="row">
                                        ...
                                        <div class="col-4 col-md-4 col-lg-3">
                                            <a href=""><span class=""><i class="fas fa-file-pdf m-button"></i></span></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-5  col-lg-3">
                                    <div class="text-left">
                                        <a href="#" class="card-link add-btn font-12  " data-toggle="modal" data-target="#exampleModals">اضافه سؤال جديد</a>
                                    </div>
                                    <!-- Modal -->
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content bg-light">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title font-14 text-dark" id="exampleModalLabel">اضافه تلخيص جديد</h5>
                                    ...
                                    <div class="card mb-3">
                                        <div class="row no-gutters">
                                            <div class="col-md-6 col-lg-8 col-xl-9">
                                                <div class="card-body">
                                                    <a href="{{url('course/description/summarize ')}}" class="btn-link">
                                                        <p class="card-text"> <span class="font-weight-bolder px-lg-3"> تلخيص الفصل الاول </span></p>
                                                    </a>                                                </div>
                                            </div>
